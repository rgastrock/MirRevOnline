...
4) did not approve consent form but did the task (N=1)
5) indicated neurological disease (N=2)
...
This led to N = 102 for the instructed group, and N = 645 for the non-instructed group.
...
For the 30 degree target, we do not find a significant relationship between step 1 path length and the corresponding reach deviation for that trial. However, this changes to a significant relationship after removing outliers (7 participants) from this analysis.
...
When we separate participants into the two subgroups of explorers and non-explorers, the relationship is not statistically significant. However, we find a clear distinction in the plots below that explorers have longer step 1 path lengths, and have more reach deviations near full compensation. Note that the for participants with move throughs in the 30 degree location, the relationship is significant (and negative), but the r-squared value is small.
...
The relationship in the 30 degree location is no longer significant after outlier removal. However, the relationship for participants with move throughs in the 60 degree location now becomes significant.
...
## Non-instructed group
Sample size: Mouse (N = 194), Trackpad (N = 451)
...
## Instructed group
Current sample size: Mouse (N = 27), Trackpad (N = 77). 1 participant did not indicate the device they used and is not included in this analysis.
...
## Non-instructed group
Sample size: Male (N = 171), Female (N = 472). 2 participants reported "other". They are not included in this analysis for biological sex.
...
## Instructed group
Current sample size: Male (N = 27), Female (N = 77). 1 participant did not indicate.
